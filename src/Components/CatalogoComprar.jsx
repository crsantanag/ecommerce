...
export const CatalogoComprar = ({ nameState, updateNameState, userName, updateUserName, cartState, updateCartState, userCart, updateUserCart }) => {
  ...
  const productos = [ 
    ...
    {"tipo": "CompactDisc", "codigo": 12, "grupo": "Pink Floyd", "nombre": "Pulse", "precio": 24990, "stock": 3, "url": "https://res.cloudinary.com/dtcg4qg4u/image/upload/v1693427874/Pink_Floyd_-_Pulse_ippvio.jpg", "ventas":0},
