...
export const VerCarro = ({ nameState, updateNameState, userName, updateUserName, cartState, updateCartState, userCart, updateUserCart }) => {
    ...
    const productos = [ 
        {"tipo": "CD", "codigo": 1, "grupo": "Pink Floyd", "nombre": "Animals", "precio": 10990, "stock": 10, "url":"https://res.cloudinary.com/dtcg4qg4u/image/upload/c_fill,h_459,w_459/v1693358556/Pink_Floyd_-_Animals_qrlo52.jpg"},
        ...
        {"tipo": "CD", "codigo": 3, "grupo": "Led Zeppelin", "nombre": "Led Zeppelin - IV", "precio": 10990, "stock": 5, "url":"https://res.cloudinary.com/dtcg4qg4u/image/upload/v1693358497/Led_Zeppelin_-_IV_r3mp1j.jpg"},
        {"tipo": "CD", "codigo": 4, "grupo": "Pink Floyd", "nombre": "Wish you Were Here", "precio": 10990, "stock": 10, "url": "https://res.cloudinary.com/dtcg4qg4u/image/upload/c_fill,h_430,w_430/v1693358928/Pink_Floyd_-_Wish_you_Were_Here_oigiob.jpg"}, 
        {"tipo": "CD", "codigo": 5, "grupo": "Pink Floyd", "nombre": "The Wall", "precio": 19990, "stock": 8, "url":"https://res.cloudinary.com/dtcg4qg4u/image/upload/c_fill,h_450,w_450/v1693359054/Pink_Floyd_-_The_Wall_ep1csz.jpg"},
        {"tipo": "CD", "codigo": 6, "grupo": "Led Zeppelin", "nombre": "The Song Remains the Same", "precio": 19990, "stock": 8, "url":"https://res.cloudinary.com/dtcg4qg4u/image/upload/v1693360349/Led_Zeppelin_-_The_Song_Remains_the_Same_sfadpt.jpg"},
        ...
        <div className="container text-center">
            <div className='row' style={{marginLeft: "0px", marginRight: "0px"}} >
                ...
                <div className="catalogo_carro" style={{backgroundColor: "white"}} key={index}>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16" style={{ cursor: 'pointer' }} onClick={(event) => handleProduct (event, index)}>
